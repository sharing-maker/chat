    ...
    <main className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-8">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-5xl font-bold text-gray-900 mb-4">Chat SDK Demo</h1>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Experience our powerful chat SDK in action. Click the chat bubble to start a conversation.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <p className="text-gray-600">Instant messaging with typing indicators and real-time updates.</p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <p className="text-gray-600">Simple to integrate with just a few lines of code.</p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <p className="text-gray-600">Fully customizable themes and components to match your brand.</p>
          </div>
        </div>

        <div className="bg-white rounded-xl shadow-lg p-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">Try It Out</h2>
