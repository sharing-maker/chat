...
const MessageList = (props: MessageListProps) => {
  ...
  const handleScroll = useCallback(() => {
    ...
    setShowScrollToBottomButton(
      distanceFromBottom > SCROLL_DOWN_THRESHOLD &&
  ...
  return (
    <div className="flex flex-col flex-1 relative h-full bg-white">
      <div className="px-4 py-3 flex items-center border-b gap-3">
        <Avatar src={conversationData?.faceURL}>
        ...
        <Button
          type="text"
          shape="circle"
          icon={<Icon icon="align-justify-o" size={24} />}
        />
        {!!onClose && (
          <Button
            type="text"
            shape="circle"
            icon={<Icon icon="close-b" size={24} />}
            onClick={onClose}
          />
        )}
      </div>
